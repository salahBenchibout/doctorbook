...
public class Admregistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admregistration);
                    ...
                    mauth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(Admregistration.this,"E"+task.getException().toString(),Toast.LENGTH_LONG).show();

                            }
                            else {

                                Intent intent=new Intent(Admregistration.this,AdmMainActivity.class);
                                ...
                                userdatabaseRef= FirebaseDatabase.getInstance().getReference().
                                        child("admins").child(currentuserid);
                               ...
                               // userinfo.put("users","1");
                                userdatabaseRef.updateChildren(userinfo).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(Admregistration.this,"Detailes Saved Succesfully.",Toast.LENGTH_LONG).show();

                                        }
                                        else{
                                            Toast.makeText(Admregistration.this,"Error Ocured"+task.getException().toString(),Toast.LENGTH_LONG).show();
                                        }
                                        finish();
                                        loader.dismiss();
                                    }
        ...
        loginpageQustion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Admregistration.this,Admlogin.class);
                startActivity(intent);
            }
        });
    }
